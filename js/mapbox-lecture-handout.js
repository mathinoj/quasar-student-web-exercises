...
// var newMarker = new mapboxgl.Marker({color: "orange", draggable:'true'})
//     .setLngLat([-159.996719, -0.374350])
//     .addTo(map)
...
//     console.log('the pop was closed')
// })
...
var alamoPopup = new mapboxgl.Popup()
    .setLngLat([-98.4895, 29.4267])
    .setHTML('<p>Mamber the ALAMO</p>')
    .addTo(map)
//WITH .setTEXT you will see the <p> tags. WITH setHTML you dont see them
// var alamoPopup = new mapboxgl.Popup({closeOnClick: false, closeButton: false})
//     .setLngLat([-98.4895, 29.4267])
//     .setText('<p>Mamber the ALAMO</p>')
//     .trackPointer()
//     .addTo(map)
/**********************************************
 *                    Geocoder
...
geocode('San Antonio, TX', firstMapboxLectureKey).then(function(results){
    console.log(results)
})

// geocode('701 Commerce St. #100A, Dallas, Texas 75202', firstMapboxLectureKey).then(function (results){
//     console.log(results);
...
// geocode('600 Navarro St #600, San Antonio, Texas, 78205', firstMapboxLectureKey).then(function (results){
//     var popUp = new mapboxgl.Popup()
...
// geocode('Portland, Maine', firstMapboxLectureKey).then(function (results){
//     var popUp = new mapboxgl.Popup()
//         .setHTML('<em>WHAT IT DO</em>')
//
//     new mapboxgl.Marker()
...
reverseGeocode({lat: 29.4260, lng:-98.4861}, firstMapboxLectureKey).then(function (results){
    console.log(results)
})
